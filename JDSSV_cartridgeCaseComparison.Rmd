...
The AUC for the All ACES logistic regression and random forest models are extremely similar, although the AUC for the logistic regression model is 0.0003235411 higher than that of the random forest model.
