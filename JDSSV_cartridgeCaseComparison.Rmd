...
The final set of features we calculate are based on visual diagnostic tools described in \jz{[Zemmels et al. (2023)]}.
...
Across all five models, the All ACES-trained logistic regression model has the largest overall test accuracy, true negative, and true positive rates of 97.91% and 98.06%, and 95.91%, respectively.
...
Our intention in fitting three classification models using different feature sets is to explore each model's strengths and weaknesses.
