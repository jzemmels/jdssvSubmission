...
$s_{m^*}$ & Standard deviation of the cell-based vertical translations (pixels) \\
$s_{n^*}$ & Standard deviation of the cell-based horizontal translations (pixels) \\
...
$\Delta_{\text{trans}}$ & Root sum of squares of the cluster-estimated translations (pixels)
\end{tabular}
...
The Fast Fourier Transform (FFT) algorithm reduces the computational load considerably \jz{[cite Tukey]}.
